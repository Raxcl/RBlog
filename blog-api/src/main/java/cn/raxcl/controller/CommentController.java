...
import cn.raxcl.model.dto.Comment;
...
public class CommentController {
	 ...
	 */
	private void judgeSendMail(Comment comment, boolean isVisitorComment, cn.raxcl.entity.Comment parentComment) {
	 ...
	 * @param comment       当前评论
	 */
	private void sendMailToParentComment(cn.raxcl.entity.Comment parentComment, Comment comment) {
		String path = "";
		String title = "";
		if (comment.getPage() == 0) {
			//普通博客
